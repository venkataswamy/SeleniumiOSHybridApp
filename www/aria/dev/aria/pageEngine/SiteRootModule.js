...
Aria.classDefinition({
    ...
    $prototype : {
         ...
         * @param {String} pageId
         */
        setPageData : function (pageData, pageId) {
            this.json.setValue(this._data.storage, "pageId", pageId);
            this.json.setValue(this._data.storage, "pageData", pageData);
        },
