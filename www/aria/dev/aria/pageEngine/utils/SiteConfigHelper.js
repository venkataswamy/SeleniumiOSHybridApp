...
Aria.classDefinition({
    ...
    $constructor : function (siteConfig) {
        ...
        aria.pageEngine.utils.PageEngineUtils.addKeyAsProperty(this._siteConfig.commonModules, "refpath");
    },
    $destructor : function () {
    ...
    $prototype : {
        ...
        getRootDivId : function () {
            return this._siteConfig.containerId;
        },
         ...
         */
        getAppData : function () {
            return this._siteConfig.appData;
        },
        ...
        getListOfContentProcessors : function () {
            var classes = [];
            for (var cp in this._siteConfig.contentProcessors) {
                if (this._siteConfig.contentProcessors.hasOwnProperty(cp)) {
                    classes.push(this._siteConfig.contentProcessors[cp]);
                }
            }
            return classes;
        },
        ...
        getContentProcessorInstances : function () {
            ...
            for (var cp in this._siteConfig.contentProcessors) {
                if (this._siteConfig.contentProcessors.hasOwnProperty(cp)) {
                    var classRef = Aria.getClassRef(this._siteConfig.contentProcessors[cp]);
                    ...
                    if (instance.processContent) {
                        ...
                        this.$logError(this.MISSING_PROCESS_METHOD, this._siteConfig.contentProcessors[cp]);
                    }
                }
            }
        ...
        getCommonModulesDescription : function (filters) {
            var commonModules = this._siteConfig.commonModules;
            if (!filters) {
        ...
        getNavigationManagerClass : function () {
            var navigationType = this._siteConfig.navigation;
            if (navigationType) {
